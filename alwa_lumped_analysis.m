%Supplement S1.Code for the analytical model.
%This code is designed to study Acouistic Leaky Wave Antennas (ALWA), based on the theory of composite right left handed materials (CRLH)
...
%Version 1.2, June 2022, Octave/Matlab
%https://github.com/obusp/alwa
%
%
%ALWA parameters
%a - waveguide radius
...
for num=1:length(f_th_list)
  for f=f_th_list(num)
    ...
    %%%%%%%%%%%%%%%%%%%%%%% ABCD matrix  - Equation 18 from supplement 2
    ...
    gamma_bloch = (acosh(A)) / d;          %equation 4 from supplement 2
    Z_bloch     = sqrt(B/C);               %equation 5 from supplement 2
